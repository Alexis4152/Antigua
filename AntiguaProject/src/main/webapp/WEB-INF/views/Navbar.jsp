...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<c:url value="/resources/ConfiguracionAdminLTE/plugins/fontawesome-free/css/all.min.css"/>" type="text/css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<c:url value="/resources/ConfiguracionAdminLTE/plugins/sweetalert2/sweetalert2.min.css"/>" type="text/css">
  <!-- Toastr -->
  	<link rel="stylesheet" href="<c:url value="/resources/ConfiguracionAdminLTE/plugins/toastr/toastr.min.css"/>" type="text/css">
  <!-- Theme style -->
  	<link rel="stylesheet" href="<c:url value="/resources/ConfiguracionAdminLTE/dist/css/adminlte.min.css"/>" type="text/css">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  
  
  
  			<!-- LLAMAMOS LA PARTE DEL DISEÑO DEL MENU COLOR Y FORMAS Y RESPONSIVE -->
<link rel="stylesheet"
	href="<c:url value="/resources/Css/estilosTabs.css"/>" 
	type="text/css"> 
<link>
...
<script lenguaje="JavaScript" type="text/javascript"src="<c:url value="/resources/JavaScript/contenidoMenuTabs.js" />"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <!--  TOY TRABAJADO EN ESTA VISTA PARA ESTE COMPONENTE  -->
