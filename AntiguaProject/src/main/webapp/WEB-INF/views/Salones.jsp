...
<head>
  ...
  <title>.: La Antigua :. | Salones</title>
          ...
          <!-- Add icons to the links using the .nav-icon class  with font-awesome or any other icon font library -->
           <li class="nav-item has-treeview menu-open">          
            <a href="<c:url value='Menu'/>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<c:url value='Salones'/>" class="nav-link active">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-5 text-center">
                      <img src="<%=request.getContextPath()%>/resources/ConfiguracionAdminLTE/dist/img/user1-128x128.jpg" alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-5 text-center">
                      <img src="<%=request.getContextPath()%>/resources/ConfiguracionAdminLTE/dist/img/user2-160x160.jpg" alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
